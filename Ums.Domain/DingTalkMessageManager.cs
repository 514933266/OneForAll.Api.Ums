...
namespace Ums.Domain
{
    ...
    public class DingTalkMessageManager : UmsBaseMQManager, IDingTalkMessageManager
    {
        ...
        public override string RouteKey => UmsQueueName.DingTalkRobot;
        ...
        public DingTalkMessageManager(
            ...
            IDingTalkHttpService httpService) : base(mqFactory, httpContextAccessor, repository)
        {
            _mapper = mapper;
        ...
        public async Task<BaseErrType> SendTextAsync(DingTalkRobotMessageForm form)
        {
            ...
            {
                return await SendToRabbitMQAsync(UmsQueueName.DingTalkRobot, UmsQueueName.DingTalkRobot, data.ToJson());
            }
            else
            {
