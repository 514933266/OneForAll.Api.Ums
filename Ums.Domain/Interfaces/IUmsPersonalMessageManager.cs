...
namespace Ums.Domain.Interfaces
{
    ...
    /// 个人消息
    /// </summary>
    public interface IUmsPersonalMessageManager
    {
        /// <summary>
        /// 查询未读消息
        /// </summary>
        ...
        Task<PageList<UmsMessage>> GetPageAsync(int pageIndex, int pageSize, string key, UmsMessageReadStatusEnum status);
