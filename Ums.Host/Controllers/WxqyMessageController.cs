...
namespace Ums.Host.Controllers
{
    ...
    public class WxqyMessageController : BaseController
    {
        ...
        public WxqyMessageController(IWxqyMessageService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        [Route("Robot/Text")]
        public async Task<BaseMessage> SendTextAsync([FromBody] WxqyRobotMessageForm form, [FromQuery] bool isSync = false)
        {
        ...
        public async Task<BaseMessage> SendMarkdownAsync([FromBody] WxqyRobotMessageForm form, [FromQuery] bool isSync = false)
        {
            var msg = new BaseMessage();
            msg.ErrType = isSync
